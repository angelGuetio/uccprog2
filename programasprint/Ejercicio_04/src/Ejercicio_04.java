...
public class Ejercicio_04 {
	public static void main(String[] args) {
		...
		System.out.println("+----------------------------------------------------+");
		System.out.println("| Programa : Operadores logicos   04                 |");
		System.out.println("+----------------------------------------------------+");
		System.out.println();
		...
		System.out.println("¿Inglaterra es un pais subamericano [0] falso // [1] verdadero?");
		a=in.nextInt();

		System.out.println("¿ Marie Currie invento el radio [0] falso // [1] verdadero?");
		b=in.nextInt();
